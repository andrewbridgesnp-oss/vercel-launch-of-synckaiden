          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a 
                ...
                className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-green-600/10 hover:bg-green-600/20 transition-all border border-green-600/30 hover:border-green-600/50"
              >
                ...
                <span className="text-sm font-medium text-green-400">Music</span>
              </a>
