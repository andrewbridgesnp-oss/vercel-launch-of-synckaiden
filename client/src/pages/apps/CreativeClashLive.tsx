...
import { Video, Trophy, Users, Clock, Loader2, Play, Award } from "lucide-react";
      ...
      <div className="min-h-screen bg-background luxury-gradient flex items-center justify-center p-4">
        <Card className="glass premium-card border-border/50 p-8 max-w-md">
          ...
          <p className="text-muted-foreground mb-6 text-center">
            Please sign in to access Creative Clash Live.
          </p>
    ...
    return (
      <div className="min-h-screen bg-background luxury-gradient flex items-center justify-center p-4">
        <Card className="glass premium-card border-border/50 p-8 max-w-md">
          ...
          <p className="text-muted-foreground mb-6 text-center">
            Subscribe to access Creative Clash Live.
          </p>
      ...
      <div className="border-b border-border/50 glass">
        <div className="container mx-auto px-6 py-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold cyan-shimmer mb-2">Creative Clash Live</h1>
              <p className="text-muted-foreground text-lg">
                Live streaming creative competitions and challenges
              </p>
            </div>
          </div>
        </div>
            ...
            <Card className="glass premium-card border-border/50 p-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Join or Create Events</h4>
                    <p className="text-sm text-muted-foreground">Participate in live creative challenges or host your own</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Compete Live</h4>
                    <p className="text-sm text-muted-foreground">Create content in real-time with other participants</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Earn points, climb the leaderboard, and win rewards</p>
                  </div>
                </div>
              </div>
            </Card>
